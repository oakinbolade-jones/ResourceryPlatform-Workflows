import type { CreateUpdateServiceWorkflowHistoryDto, ServiceWorkflowHistoryDto } from './models';
...
export class ServiceWorkflowHistoryService {
  ...
  update = (id: string, input: CreateUpdateServiceWorkflowHistoryDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ServiceWorkflowHistoryDto>({
      method: 'PUT',
      url: `/api/workflow/service-workflow-history/${id}`,
      body: input,
