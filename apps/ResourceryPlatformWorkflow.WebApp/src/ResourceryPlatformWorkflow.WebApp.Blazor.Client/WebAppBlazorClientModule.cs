...
using ResourceryPlatformWorkflow.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(ResourceryPlatformWorkflowWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(ResourceryPlatformWorkflowNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryPlatformWorkflowNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryPlatformWorkflowNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryPlatformWorkflowNames.WebAppApi);
        });
    }
