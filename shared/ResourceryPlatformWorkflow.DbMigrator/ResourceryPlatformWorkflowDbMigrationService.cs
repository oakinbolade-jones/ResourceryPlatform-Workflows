...
public class ResourceryPlatformWorkflowDbMigrationService(
    ILogger<ResourceryPlatformWorkflowDbMigrationService> logger,
...
) : ITransientDependency
{
    ...
    private readonly ILogger<ResourceryPlatformWorkflowDbMigrationService> _logger = logger;
    ...
    private async Task CreateDatabasesAsync(CancellationToken cancellationToken)
    {
        ...
        await EnsureDatabaseAsync<WorkflowDbContext>(cancellationToken);
