...
namespace ResourceryPlatformWorkflow.Workflow.HttpApi.Client.ConsoleTestApp;
...
) : ITransientDependency
{
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url =
                _configuration["RemoteServices:Workflow:BaseUrl"]
                + "api/Workflow/sample/authorized";
